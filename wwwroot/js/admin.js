...
btnUpdateProductIn.addEventListener("click", (e) => {
    ...
    let titleProductCur = document.getElementById("ten-game").value;
    let curProductCur = document.getElementById("gia-game").value;
    let descProductCur = document.getElementById("mo-ta").value;
    let categoryText = document.getElementById("chon-game").value;
...
btnAddProductIn.addEventListener("click", (e) => {
    ...
    let tenMon = document.getElementById("ten-game").value;
    let price = document.getElementById("gia-game").value;
...
function setDefaultValue() {
    ...
    document.getElementById("ten-game").value = "";
    document.getElementById("gia-moi").value = "";
    document.getElementById("mo-ta").value = "";
    document.getElementById("chon-game").value = "Game Triple A";
}
...
function uploadImage(el) {
    let path = "./assets/img/file_img_game/" + el.value.split("\\")[2];
